  ...
  return (
    <div className="bg-gray-900 dark:bg-gray-900 h-screen ">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a
          href="/"
          className="flex items-center mb-6 text-2xl font-semibold text-white dark:text-white animate-bounce"
        >
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  to="/login"
                  className="text-sm font-medium text-[#1d4ed8] hover:underline dark:text-primary-500"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <Link
                  to="register"
                  className="font-medium text-[#1d4ed8] hover:underline dark:text-primary-500"
                >
                  Register
                </Link>
              </p>
